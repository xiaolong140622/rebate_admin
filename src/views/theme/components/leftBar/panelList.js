            ...
            roll: [
              {
                ...
                url: '/news_list',
                info:
                  'mshop基于springboot2+Mybatisplus商城系统，3.0版本重构了代码，新增了运费模板、sku单独管理、商品券等',
        ...
        // 菜单
        {
          ...
          componentContent: {
            menus: [
              {
                imageArr: [
                  'https://image.xxx.cn/5e85bfa61251d.png'
                ],
                uniapp_url: '/pages/shop/GoodsList/index',
                name: '全部商品',
                id: 180,
                pic: 'https://image.xxx.cn/all.png',
                sort: 9,
                url: '/goods_list',
              ...
              {
                imageArr: ['https://image.xxx.cn/news.png'],
                uniapp_url: '/pages/shop/news/NewsList/index',
                name: '图文资讯',
                id: 196,
                pic: 'https://image.xxx.cn/xw.png',
                sort: 8,
                url: '/news_list',
                wxapp_url: '/pages/shop/news/NewsList/main',
                status: 1
              ...
              {
                imageArr: [
                  'https://image.xxx.cn/5e4e939507b5e.png'
                ],
                uniapp_url: '/pages/shop/GoodsCollection/index',
                name: '我的收藏',
                id: 197,
                pic: 'https://image.xxx.cn/colle.png',
                sort: 7,
                url: '/collection',
              ...
              {
                imageArr: ['https://image.xxx.cn/coupon.png'],
                uniapp_url: '',
                name: '优惠券',
                id: 199,
                pic: 'https://image.xxx.cn/cou.png',
                sort: 6,
                url: '/user/get_coupon',
              ...
              {
                imageArr: ['https://image.xxx.cn/pink.png'],
                uniapp_url: '/pages/activity/GoodsGroup/index',
                name: '拼团专区',
                id: 200,
                pic:
                  'https://image.xxx.cn/62ac09d2914d36c65b9b59d2147d809a.png',
                sort: 5,
                url: '/activity/group',
              ...
              {
                imageArr: ['https://image.xxx.cn/sign.png'],
                uniapp_url: '/pages/user/signIn/Sign/index',
                name: '积分签到',
                id: 209,
                pic:
                  'https://image.xxx.cn/29ea4acebbf99e7eaf6f85af2b6d79ae.png',
                sort: 4,
                url: '/user/sign',
              ...
              {
                imageArr: ['https://image.xxx.cn/sekill.png'],
                uniapp_url: '/pages/activity/GoodsSeckill/index',
                name: '秒杀专区',
                id: 216,
                pic:
                  'https://image.xxx.cn/b0344c148141b50d68db9722708ea49e.png',
                sort: 3,
              ...
              {
                imageArr: ['https://image.xxx.cn/bargin.png'],
                uniapp_url: '/pages/activity/GoodsBargain/index',
                name: '砍价专区',
                id: 217,
                pic: 'https://image.xxx.cn/bar.png',
                sort: 2,
        ...
        // 广告
        {
          ...
          componentContent: {
            detail: {
              list: [
                {
                  image: 'https://wx.xxx.co/static/images/index001.png',
                  url: '',
                  uniapp_url: '',
                  wxapp_url: '',
                  path_type: 1
                ...
                {
                  image: 'https://wx.xxx.co/static/images/index002.png',
                  url: '',
                  uniapp_url: '',
                  wxapp_url: '',
                  path_type: 1
                ...
                {
                  image: 'https://wx.xxx.co/static/images/index003.png',
                  url: '',
                  uniapp_url: '',
                  wxapp_url: '',
                  path_type: 1
          ...
          componentContent: {
            bannerList: [
              ...
              },
              {
                title: '轮播2',
                des: '',
                pic: 'https://image.xxx.cn/5c9f05aee5059.jpg',
                url: '',
                linkTo: ''
              }
            ]
            ...
            'product': [
                {
                  'title': '新款商品1',
                  'id': '1',
                  'pic': 'https://wxapi.xxx.co/api/file/pic/20210222213116280067.jpeg',
