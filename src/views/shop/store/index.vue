  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','mwSystemStore:edit','mwSystemStore:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
  ...
  // crud交由presenter持有
  const defaultCrud = CRUD({ title: '门店', url: 'api/mwSystemStore', sort: 'id,desc', crudMethod: { ...crudMwSystemStore }})
  ...
  export default {
    ...
    data() {
      return {
        permission: {
          add: ['admin', 'mwSystemStore:add'],
          edit: ['admin', 'mwSystemStore:edit'],
          del: ['admin', 'mwSystemStore:del']
        },
        rules: {
          name: [
    ...
    methods: {
      ...
      getL(addr) {
        crudMwSystemStore.getL({addr}).then(res => {
