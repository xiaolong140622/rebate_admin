<template>
  <div class="afterSealsContainer">
    ...
    <!-- @selection-change="selectionChangeHandler" -->
      ...
      <el-table-column
      v-permission="['admin','mwStoreAfterSales:edit','mwStoreAfterSales:del']" label="操作" width="150px" align="center">
        <template slot-scope="scope">
...
import {rebackMoney} from '@/api/mwStoreAfterSales'
import CheckDialog from './checkDialog.vue'
export default {
  name: 'MwStoreAfterSales',
  ...
  data() {
    return {
      ...
      searchTime: [],
      permission: {
        add: ['admin', 'mwStoreAfterSales:add'],
        edit: ['admin', 'mwStoreAfterSales:edit'],
        del: ['admin', 'mwStoreAfterSales:del']
      },
      salesOptions: [
        { key: 0, name: '正常'},
        { key: 1, name: '用户已取消' },
  ...
  methods: {
    beforeInit() {
      this.url = 'api/mwStoreAfterSales/sales/List'
      this.params = {
        page: this.page,
        size: this.size,
