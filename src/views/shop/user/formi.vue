<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" :title="isAdd ? '新增' : '积分修改'" width="500px">
...
<script>
import { add, edit, editi } from '@/api/mwUser'
