  ...
  <div class="app-container" style="position: relative; height: calc(100vh - 117px);">
    <div class="container">
      ...
      <el-table ref="multipleTable" v-loading="loading" :data="data" size="small" style="width: 100%;" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="tbEnergy" label="淘赠"/>
        <el-table-column prop="jdEnergy" label="京赠"/>
        <el-table-column prop="pddEnergy" label="多赠"/>
        <el-table-column prop="dyEnergy" label="抖赠"/>
        <el-table-column prop="vipEnergy" label="唯赠"/>
        <el-table-column prop="tbTuiEnergy" label="淘推"/>
        <el-table-column prop="jdTuiEnergy" label="京推"/>
        <el-table-column prop="pddTuiEnergy" label="多推"/>
        <el-table-column prop="dyTuiEnergy" label="抖推"/>
        <el-table-column prop="vipTuiEnergy" label="唯推"/>
        <el-table-column prop="tbDay" label="淘日"/>
        <el-table-column prop="jdDay" label="京日"/>
        <el-table-column prop="pddDay" label="多日"/>
        <el-table-column prop="dyDay" label="抖日"/>
        <el-table-column prop="vipDay" label="唯日"/>
